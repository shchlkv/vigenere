...
word=list('безинформатикинетникчемноесуществованиеэтогомирабудущегоиникодганебудетмирбезмашинэтонемирэтопостноесуществование')
...
for i in range(len(word)):
        if crypt_word[i] in alphabet:         #cheking of letters from list 'word' with index 'i' in list 'alphabet'
                letter=crypt_word[i]          #this variable 'letter' contains letter from list 'word' with index 'i'.
                index_of_letter_from_list_alphabet=alphabet.index(letter) #this variable contains index of letter from 'alphabet' list
                indexes_of_cript_word.append(index_of_letter_from_list_alphabet)        # insert 'index_of_letter_from_list_alphabet' in  list 'indexes_of_keyword' 
